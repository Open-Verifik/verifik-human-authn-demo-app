					...
					<details className="mt-10 rounded-xl border border-outline-variant/20 bg-surface-container-low/50 text-left max-w-3xl mx-auto w-full px-4 py-3 group">
						...
						<div className="mt-4 space-y-4 text-sm text-on-surface-variant border-t border-outline-variant/15 pt-4">
							<p>
								...
								>
									docs.verifik.co/resources/create-a-person
								</a>
							</p>
							<p className="text-xs leading-relaxed">
								Base URL <code className="text-primary">https://api.verifik.co</code>. Send JSON with profile fields and at least one
								base64 face image per entry in <code className="text-primary">images</code> (no data URL prefix). The public docs also
								list optional fields such as <code className="text-primary">notes</code>, <code className="text-primary">email</code>, and{" "}
								<code className="text-primary">phone</code>.
							</p>
							<div>
								<p className="font-mono text-xs text-on-surface mb-1">POST /v2/face-recognition/persons</p>
								<p className="text-xs leading-relaxed">
									Enrolls a new person into the given collection ids (collection <code className="text-primary">_id</code> values)
									with face biometrics for OpenCV-backed recognition.
								</p>
							</div>
								...
								<table className="w-full text-xs border-collapse">
									...
									<tbody className="text-on-surface-variant">
										...
										<tr className="border-b border-outline-variant/10 align-top">
											...
											<td>Yes</td>
											<td>M or F (required in this demo)</td>
										</tr>
										<tr className="border-b border-outline-variant/10 align-top">
											<td className="py-2 font-mono text-primary">date_of_birth</td>
											<td>Yes</td>
											<td>YYYY-MM-DD (required in this demo)</td>
										</tr>
										<tr className="border-b border-outline-variant/10 align-top">
										...
										<tr className="align-top">
											...
											<td>No</td>
											<td>Optional country / nationality code or label</td>
										</tr>
									</tbody>
								</table>
							</div>
  ...
  "data": {
    ...
    "…": "…"
							...
							<ul className="list-disc pl-5 space-y-1 text-xs">
								<li>
									This demo uses <code className="text-primary">createPerson</code> from{" "}
									<code className="text-primary">@humanauthn/api-client</code> with your session token.
								</li>
								<li>
									Responses may include <code className="text-primary">id</code> and a <code className="text-primary">signature</code>{" "}
									block alongside <code className="text-primary">data</code> depending on environment.
								</li>
							</ul>
						</div>
					</details>
