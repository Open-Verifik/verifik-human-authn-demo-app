...
type SearchLivePersonResultProps = {
...
export default function SearchLivePersonResult({ result, onReset }: SearchLivePersonResultProps) {
	...
	const parsed = useMemo(() => {
		...
		const rawMatches = Array.isArray(data?.search) ? data.search : [];
		...
		const liveness = isPlainObject(data?.liveness)
			? {
					id: typeof data.liveness._id === "string" ? data.liveness._id : "",
					status: typeof data.liveness.status === "string" ? data.liveness.status : "",
					searchMode: typeof data.liveness.search_mode === "string" ? data.liveness.search_mode : "",
					os: typeof data.liveness.os === "string" ? data.liveness.os : "",
					createdAt: typeof data.liveness.createdAt === "string" ? data.liveness.createdAt : "",
					updatedAt: typeof data.liveness.updatedAt === "string" ? data.liveness.updatedAt : "",
					result: isPlainObject(data.liveness.result)
						? {
								livenessScore:
									typeof data.liveness.result.liveness_score === "number" ? data.liveness.result.liveness_score : null,
								passed: typeof data.liveness.result.passed === "boolean" ? data.liveness.result.passed : null,
								minScore: typeof data.liveness.result.min_score === "number" ? data.liveness.result.min_score : null,
							}
						: null,
				}
			: null;
