...
export default function SearchActiveUserPage() {
	const t = useTranslations("demos.searchActiveUser");
					...
					<div className="space-y-5">
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
							<div>
								<label className="block text-sm font-semibold text-on-surface mb-1.5">
									{t("livenessMinLabel", { score: livenessMinScore.toFixed(2) })}
								</label>
								<input
									type="range"
									min="0.5"
							...
							<div>
								<label className="block text-sm font-semibold text-on-surface mb-1.5">
									{t("searchMinLabel", { score: minScore.toFixed(2) })}
								</label>
								<input
									type="range"
									min="0.5"
						...
						<div className="flex flex-wrap gap-3">
							{image && (
								...
								>
									{loading ? t("searching") : t("searchActiveUser")}
								</button>
							)}
						</div>
						...
						{result && <SearchActiveUserResult result={result} onReset={reset} />}
					</div>
				)}
