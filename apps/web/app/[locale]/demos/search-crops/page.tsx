...
export default function SearchCropsPage() {
	const t = useTranslations("demos.searchCrops");
				...
				{!hasHydrated ? (
					...
					<div className="space-y-5">
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
							...
							<div>
								<label className="block text-sm font-semibold text-on-surface mb-1.5">{t("maxResultsLabel")}</label>
								<input
									type="text"
									inputMode="numeric"
									value={maxResults}
						...
						<div className="space-y-5">
							...
							<section aria-labelledby="search-crops-upload-heading">
								...
								<DemoUploadImageButton
									...
									primaryText={images.length ? t("cropsAddMore", { count: images.length }) : t("uploadFaceCrops")}
