...
export default function SearchLivePersonPage() {
	const t = useTranslations("demos.searchLivePerson");
					...
					<div className="space-y-5">
						...
						<div className="flex flex-wrap gap-3">
							{image && (
								...
								>
									{loading ? t("searching") : t("searchLive")}
								</button>
							)}
						</div>
						...
						{result && <SearchLivePersonResult result={result} onReset={reset} />}
					</div>
				)}
